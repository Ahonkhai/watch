/* GENERATED FILE — written by the Telegram listing bot.
 *
  ...
  "collections": [
    {
      "id": "rolex",
      "name": "Rolex",
      "blurb": "Submariner, GMT-Master, Daytona."
    },
    {
      "id": "omega",
      "name": "Omega",
      "blurb": "Speedmaster and Seamaster."
    },
    {
      "id": "tudor",
      "name": "Tudor",
      "blurb": "Black Bay and Pelagos."
    },
    {
      "id": "cartier",
      "name": "Cartier",
      "blurb": "Santos, Tank, Ballon Bleu."
    },
    {
      "id": "iwc",
      "name": "IWC",
      "blurb": "Pilot, Portugieser, Ingenieur."
    },
    {
      "id": "audemars-piguet",
    ...
    },
    {
      "id": "patek-philippe",
      "name": "Patek Philippe",
      "blurb": "Nautilus, Calatrava, Aquanaut."
    },
    {
      "id": "panerai",
      "name": "Panerai",
      "blurb": "Luminor and Radiomir."
    },
    {
      "id": "breitling",
      "name": "Breitling",
      "blurb": "Navitimer and Superocean."
    }
  ],
  "products": [
    {
      ...
      "collection": "rolex",
      "name": "Bruce Wayne 4A",
      "reference": "129720BLNR",
      "year": 2022,
      "condition": "Excellent",
      "set": "Full set",
      "price": 14500,
      "tagline": "Oystersteel on Jubilee bracelet, blue and black Cerachrom bezel.",
      "description": "Worn lightly, no notable marks. Box, card and certificate present.",
      "images": [
        "assets/img/rolex-129720blnr/01.jpg"
      ],
      "specs": {
    ...
    },
    {
      ...
      "description": "Unworn 2023 example with stickers intact, supplied with the original box, card and hang tags. Purchased from an authorised dealer; the card is dated and matches the case number.",
      "images": [],
      "specs": {
        "Case diameter": "41 mm",
        "Case material": "Oystersteel",
    ...
    },
    {
      ...
      "description": "Honest example of the discontinued 116500LN with visible wear to the bracelet and a light scratch on the case flank, photographed in detail. Card present, outer box not included.",
      "images": [],
      "specs": {
        "Case diameter": "40 mm",
        "Case material": "Oystersteel",
    ...
    },
    {
      ...
      "description": "The current-generation Moonwatch on the Hesalite crystal specification. Worn occasionally, no notable marks. Complete with the full presentation box, warranty card and extra strap.",
      "images": [],
      "specs": {
        "Case diameter": "42 mm",
    ...
    },
    {
      ...
      "description": "Regularly worn but carefully kept, with light marks to the bracelet only. Box, card and manuals present. Bracelet full length with all removed links included.",
      "images": [],
      "specs": {
        "Case diameter": "42 mm",
        "Case material": "Stainless steel",
    ...
    },
    {
      ...
      "description": "Unworn with protective stickers in place, on the riveted steel bracelet. Supplied with the original box, warranty card and the additional fabric strap.",
      "images": [],
      "specs": {
        "Case diameter": "39 mm",
        "Case material": "Stainless steel",
    ...
    },
    {
      ...
      "description": "Large model in steel with both the steel bracelet and the leather strap, each fitted with the QuickSwitch system. Minor marks to the bracelet, case sharp. Box and certificate present.",
      "images": [],
      "specs": {
    ...
    },
    {
      ...
      "description": "The smaller 43 mm Big Pilot with the soft-iron inner case. Supplied on the steel bracelet with the quick-change system, plus the original leather strap, box and papers.",
      "images": [],
      "specs": {
        "Case diameter": "43 mm",
        "Case material": "Stainless steel",
    ...
    },
    {
      ...
      "description": "Worn lightly and kept boxed. Brushed surfaces crisp with no polishing, bevels sharp. Complete with box, certificate and the original purchase documentation.",
      "images": [],
      "specs": {
        "Case diameter": "41 mm",
        "Case material": "Stainless steel",
    ...
    },
    {
      ...
      "description": "The blue-dial steel Nautilus, discontinued in 2021. Light wear consistent with careful use, no polishing. Complete with box, certificate of origin and setting pin.",
      "images": [],
      "specs": {
        "Case diameter": "40 mm",
        "Case material": "Stainless steel",
    ...
    },
    {
      ...
      "description": "Brushed steel case with the crown-protecting bridge, on the original leather strap with a spare rubber strap included. Box, papers and the strap-change tool present.",
      "images": [],
      "specs": {
        "Case diameter": "44 mm",
    ...
    },
    {
      ...
      "description": "Unworn, stickered, on the alligator strap with folding clasp. Supplied with the full box set and warranty documentation dated 2023.",
      "images": [],
      "specs": {
        "Case diameter": "43 mm",
        "Case material": "Stainless steel",
